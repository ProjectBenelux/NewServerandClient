	...
	public void processPacket(Client c, int packetType, int packetSize) {
		...
		switch(packetType) {
			...
			**/
			...
			if((c.playerEquipment[c.playerWeapon] == 11235) && (c.playerEquipment[c.playerArrows] != 11212)){
				c.sendMessage("you need dragon arrows to attack with a dark bow");
				c.stopMovement();
				c.getCombat().resetPlayerAttack();
				return;
			}
			if((c.playerEquipment[c.playerWeapon] == 15701) && (c.playerEquipment[c.playerArrows] != 11212)){
				c.sendMessage("you need dragon arrows to attack with a dark bow");
				c.stopMovement();
				c.getCombat().resetPlayerAttack();
				return;
			}
			if((c.playerEquipment[c.playerWeapon] == 15702) && (c.playerEquipment[c.playerArrows] != 11212)){
				c.sendMessage("you need dragon arrows to attack with a dark bow");
				c.stopMovement();
				c.getCombat().resetPlayerAttack();
				return;
			}
			if((c.playerEquipment[c.playerWeapon] == 15703) && (c.playerEquipment[c.playerArrows] != 11212)){
				c.sendMessage("you need dragon arrows to attack with a dark bow");
				c.stopMovement();
				c.getCombat().resetPlayerAttack();
				return;
			}
			if((c.playerEquipment[c.playerWeapon] == 15704) && (c.playerEquipment[c.playerArrows] != 11212)){
				c.sendMessage("you need dragon arrows to attack with a dark bow");
				c.stopMovement();
				c.getCombat().resetPlayerAttack();
				return;
			}
			if (c.playerEquipment[c.playerWeapon] == 9185 && c.playerEquipment[c.playerWeapon] == 18357 && !c.getCombat().properBolts()) {
...
case 6816:
case 6873:
if (Server.npcHandler.npcs[c.npcClickIndex].npcId == c.summoningnpcid && c.playerRights != 2) { 
