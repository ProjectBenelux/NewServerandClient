	...
	**/
	...
	public void getRequirements(String itemName, int itemId) {
		...
		if(itemName.contains("rune")) {
			if(!itemName.contains("knife") && !itemName.contains("dart") && !itemName.contains("javelin") && !itemName.contains("thrownaxe") && !itemName.contains("crossbow")) {
...
if (isStackable(itemID) && c.occupied[c.summoningslot] == false && c.maxstore > c.summoningslot && c.maxstore != c.totalstored) {
c.stackableItemSlot(itemID);
...
if(c.amount[c.summoningslot] != 0) {
c.getPA().Frame34(7423, itemID, c.summoningslot, c.amount[c.summoningslot]+1);
}
...
c.amount[c.summoningslot] = c.amount[c.summoningslot]+1;
resetTempItems();
resetBank();
...
if(c.occupied[c.summoningslot] == false && c.maxstore > c.summoningslot && c.maxstore != c.totalstored && !isStackable(itemID)) {
